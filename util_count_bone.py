...
class CMskCountBone(bpy.types.Operator):
##class CMskCountBone():
    bl_idname = "masak.msk_util_count_bone"
    bl_label = "msk_util_count_bone"
    bl_description = "Return Number of bone"
